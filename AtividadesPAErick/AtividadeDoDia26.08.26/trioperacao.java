...
public class trioperacao {//nome da classe
    public static void main(String[] args) {//inicia o programa
        JOptionPane.showMessageDialog(null,"iremos começar as operações com matrizes 3x3");
        ...
        //i escaneia as linhas, j as colunas
        int i, j;
        ...
        System.out.println("Por que esta olhando o monitor?");
        ...
        // posicao 0=adicao, 1=subtracao, 2=divisao, 3=sair
        String[] matematica = {"Adição", "Subtração", "Divisão", "Sair?"};
        while(true) {// loop que volta para o menu sem parar
            ...
            int numeroslegais = JOptionPane.showOptionDialog(null,"Faça uma operação de sua escolha:", "Escolha sabiamente:", JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE, null, matematica, matematica[3]);
            //3=clicou em sair e -1=fechou a janela no x (não use o x, fiz o botao de sair só pra isso)
            if (numeroslegais == 3 || numeroslegais == -1) {
                JOptionPane.showMessageDialog(null,"Voce nao ira embora tão cedo");
                JOptionPane.showMessageDialog(null,"porque...");
                JOptionPane.showMessageDialog(null,"voce foi hackeado hahahaha");
